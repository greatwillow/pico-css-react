...
.pico-styles details summary[role=button]:not(.outline).contrast::after {
...
.pico-styles dialog article .close {
  display: block;
  width: 1rem;
  height: 1rem;
...
.pico-styles dialog article .close:is([aria-current], .pico-styles :hover, .pico-styles :active, .pico-styles :focus) {
  opacity: 1;
}
...
.pico-styles .modal-is-open {
  padding-right: var(--scrollbar-width, 0px);
  overflow: hidden;
  pointer-events: none;
}
.pico-styles .modal-is-open dialog {
  pointer-events: auto;
}

.pico-styles :where(.modal-is-opening, .pico-styles .modal-is-closing) dialog, .pico-styles :where(.modal-is-opening, .pico-styles .modal-is-closing) dialog > article {
...
.pico-styles :where(.modal-is-opening, .pico-styles .modal-is-closing) dialog {
  -webkit-animation-duration: 0.8s;
  animation-duration: 0.8s;
  -webkit-animation-name: fadeIn;
  animation-name: fadeIn;
}
.pico-styles :where(.modal-is-opening, .pico-styles .modal-is-closing) dialog > article {
...
.pico-styles .modal-is-closing dialog, .pico-styles .modal-is-closing dialog > article {
